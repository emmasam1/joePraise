...
const formatIdType = (type) => {
  ...
  return labels[type] || "Not Uploaded Yet";
};
          ...
          <div className="grid grid-cols-2 gap-y-5 gap-x-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-slate-800 leading-tight">{formatIdType(business.owner?.identificationType)}</p>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <p className="text-xs font-bold text-slate-800 truncate leading-tight">{business.owner?.identificationNumber || "Not Uploaded Yet"}</p>
