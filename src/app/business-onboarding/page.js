...
// import { PlusOutlined, DeleteOutlined, CheckCircleFilled, LoadingOutlined } from "@ant-design/icons";
...
//   const { onboardBusiness, registerInitialUser, onboardingLoading, fetchBusinessCategories } = useBusinessStore();
...
//     // NEW: category is now an array — check it has at least one selection
...
//           message.error(
//             "A Business Registration Certificate is required."
//           );
//           return;
//         }
...
//           message.error(
//             "A valid Proof of Identification is required."
//           );
//           return;
//         }
...
//                   {/* NEW: multi-select, populated from the live category API,
//                       with a lazy-loading spinner while fetching. */}
//                   <Select
//                     mode="multiple"
//                     size="small"
