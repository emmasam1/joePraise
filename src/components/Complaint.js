...
const Complaint = () => {
  ...
  const stats = [
    ...
    { label: "AVG RESPONSE TIME", value: "21.5", unit: "/ Min" },
    { label: "ERROR RATE", value: ".5%" },
  ];

  // Table Data
  const dataSource = [
    { key: '1', complaint: 'In-app purchase not credited', date: 'Sep 26, 12:08 AM', resolved: '14:30' },
    { key: '2', complaint: 'Login failed on iOS 17.4', date: 'Sep 26, 12:08 AM', resolved: '14:30' },
    { key: '3', complaint: 'App crashes on startup', date: 'Sep 26, 12:08 AM', resolved: '14:30' },
    { key: '4', complaint: 'App crashes on startup', date: 'Sep 26, 12:08 AM', resolved: '14:30' },
    { key: '5', complaint: 'In-app purchase not credited', date: 'Sep 26, 12:08 AM', resolved: '14:30' },
    { key: '6', complaint: 'Login failed on iOS 17.4', date: 'Sep 26, 12:08 AM', resolved: '14:30' },
    { key: '7', complaint: 'App crashes on startup', date: 'Sep 26, 12:08 AM', resolved: '14:30' },
  ];
